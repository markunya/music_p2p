...
from src.schedulers.flow_match_euler_inverse import FlowMatchEulerInverseDiscreteScheduler
...
def get_inverse_scheduler(scheduler_type: SchedulerType):
    match scheduler_type:
        ...
        case _:
            raise ValueError(_invalid_scheduler_type_msg.format(scheduler_type=scheduler_type))
