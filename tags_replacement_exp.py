...
[
    ...
    #     tgt_tags="female voice, Cuban music, salsa, son, Afro-Cuban, traditional Cuban",
    #     seed=11
    # ),
    # TagsExpParams(
    ...
    #     src_tags="Nightclubs, dance parties, male voice, workout playlists, radio broadcasts",
    #     tgt_tags="Nightclubs, dance parties, female voice, workout playlists, radio broadcasts",
    #     seed=12
    # ),
    # TagsExpParams(
    #     identifier="death rock",
    ...
    #     src_tags="dark, death rock, male voice, metal, hardcore, electric guitar, powerful, bass, drums, 110 bpm, G major",
    #     tgt_tags="dark, death rock, female voice, metal, hardcore, electric guitar, powerful, bass, drums, 110 bpm, G major",
    #     seed=13
    # ),
]
    ...
    for exp_name, block_idxs in EXPERIMENT_INJECTION_CONFIGS.items():
        ...
        for tags_param in TAGS_EXP_PARAMS_LIST:
            ...
            controller = AttentionReplaceTags(
                ...
                step_callback=SkipSteps(0),
                num_diffusion_steps=60,
                diffusion_step_start=0,
                diffusion_step_end=30
            )
            pipe.controller = controller

            output_dir = os.path.join("outputs_tags2", exp_name, tags_param.identifier)
